...
func (_m *MerchantRepositoryInterface) GetById(_a0 string) (*billing.MgoMerchant, error) {
	ret := _m.Called(_a0)

	var r0 *billing.MgoMerchant
	if rf, ok := ret.Get(0).(func(string) *billing.MgoMerchant); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*billing.MgoMerchant)
		}
	}
